...
def read_start(startFN):
    ...
    with open(startFN, encoding='cp1251') as startf:
...
def read_prj(prjFN):
    d = {}
    with open(prjFN, encoding='cp1251') as prjf:
...
def read_grid(grdFN):
    d = {}
    with open(grdFN, encoding='cp1251') as grdf:
        grdf.readline()  # <FULL>
        grdf.readline()  # 1
...
def read_par(parFN):
    d = dict()
    parfile = open(parFN, encoding='cp1251')
    parfile.readline()
    parfile.readline()
...
def read_lay(layFN):
    ...
    layfile = open(layFN, encoding='cp1251')
    layfile.readline()
    layfile.readline()
...
def read_pl(plFN):
    d = dict()
    plfile = open(plFN, encoding='cp1251')
    plfile.readline()
    plfile.readline()
